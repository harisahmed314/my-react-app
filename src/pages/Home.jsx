    ...
    return (<div>
        <div className="bg-blue-500 relative overflow-hidden h-96">
            ...
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center">
                ...
                <a href="#" className="bg-white text-blue-500 hover:bg-blue-700 hover:text-white px-6 py-3 rounded-full text-lg font-semibold transition duration-300">Shop Now</a>
            </div>
        </div>
